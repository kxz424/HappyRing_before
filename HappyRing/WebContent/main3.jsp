...
<script src="https://code.jquery.com/jquery-3.2.1.min.js" integrity="sha256-hwg4gsxgFZhOsEEamdOYGBf13FyQuiTwlAQgxVSNgt4=" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    <section class="section section-variant-2 bg-gray-lighter" style="padding-top: 20px; padding-bottom: 2px;">
...
<!--           <div  style="border: solid;  -->
             <div  style=" 
                padding-left: 20px; padding-right: 20px; padding-top: 20px; padding-bottom: 107px;">
              
              <!-- 세부영역A -->
                <div style="border: solid; border-color: pink; height: 60px; padding-top: 10px;"><h4>공지) 해피링 심리서비스가 오픈하였습니다</h4></div>
                <div style="border: solid; border-color: yellow; padding-top: 85px;">
...
<!--                 <div style="border: solid; border-color: pink;">A-3</div> -->
       ...
       <div class="col-md-2" style="padding-left: 0px;">
          <div style="border: solid; border-color: red; padding-left: 0px; padding-right: 0px;
...
<!--                B-1 -->
               ...
               <!-- 심리테스트 영역 시작  -->
               <div style="border: solid; border-color: purple; margin-top: 146px;">
<!--                B-2 -->
...
<!--                 <div class="row" style=" margin-left: 0px; margin-right: 0px;  padding-left: 14px;  padding-right: 14px;"> -->
               ...
               <!-- 날씨 영역  시작-->
               <div style="border: solid; border-color: babyblue; margin-top: 146px;">B-3
    ...
    <section class="breadcrumbs-custom breadcrumbs-custom-lg breadcrumbs-custom-svg" style="padding-top: 0px;">
     ...
     <div class="row">
       <div class="col-md-1"></div>
       <div class="col-md-8" style="padding-right: 0px;margin-top: -229.4px;"> 
