...
<script src="https://code.jquery.com/jquery-3.2.1.min.js" integrity="sha256-hwg4gsxgFZhOsEEamdOYGBf13FyQuiTwlAQgxVSNgt4=" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    <section class="section section-variant-2 bg-gray-lighter" style="padding-top: 20px; padding-bottom: 246px;">
...
<!--           <div  style="border: solid;  -->
             <div  style=" 
              ...
              <!-- 세부영역A -->
                ...
                <div style="border: solid; border-color: yellow; height: auto;">심리이론 베스트
...
<!--                 <div class="row" style=" margin-left: 0px; margin-right: 0px;  padding-left: 14px;  padding-right: 14px;"> -->
    ...
    <section class="breadcrumbs-custom breadcrumbs-custom-lg breadcrumbs-custom-svg" style="padding-top: 0px;">
     ...
     <div class="row">
       <div class="col-md-1"></div>
       <div class="col-md-8" style="padding-right: 0px;margin-top: -226.4px;"> 
          <div style="border: solid; padding-left: 20px; padding-right: 20px;
               padding-top: 20px; padding-bottom: 20px;">C
   
   <!-- C-1영역 --> 
    <div style="border: solid; border-color: yellow; height: auto;" >
    <!-- 탭 -->
