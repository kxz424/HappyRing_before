...
<title>Insert title here</title>
   <meta name="format-detection" content="telephone=no">
    ...
    <meta charset="utf-8">
    <link rel="icon" href="/HappyRing_before_before/images/favicon.ico" type="image/x-icon">
 	
 	<!-- 심리이론 Frame Stylesheets -->
    <link rel="stylesheet" href="/HappyRing_before_before/css/theory/theoryFrame.css">
    <link rel="stylesheet" href="/HappyRing_before_before/css/info/info.css">
...
<!--                                     style="background-image: url(/HappyRing_before_before/img/sample/bright.png); background-repeat: no-repeat; background-size: contain; background-color: white;"> -->
<!--                                     <div class="swiper-slide-caption"> -->
<!--                                        <div class="section-md"></div> -->
<!--                                     </div> -->
<!--                                  </div> -->
								<div class="swiper-slide"
                                    data-slide-bg="/HappyRing_before_before/images/slider-1-slide-1-1920x910.jpg">
                                    <div class="swiper-slide-caption">
                                       <div class="section-md"></div>
                                    </div>
                                 </div>
                                 <div class="swiper-slide"
                                    data-slide-bg="/HappyRing_before_before/images/slider-1-slide-2-1920x910.jpg">
                                    <div class="swiper-slide-caption">
                                       <div class="section-md"></div>
                                    </div>
                                 </div>
                                 <div class="swiper-slide"
                                    data-slide-bg="/HappyRing_before_before/images/slider-1-slide-3-1920x910.jpg">
                                    <div class="swiper-slide-caption">
                                       <div class="section-md"></div>
                                    </div>
                                 </div>
		                    ...
		                    <div class="isotope" data-isotope-group="theory1" data-lightgallery="group">
		                      <div class="row">
                      				...
                      				<div class="col-xs-12 col-sm-4 col-md-4 isotope-item" data-filter="type 1">
						                 <a class="gallery-item" href="/HappyRing_before_before/view/info/infoDetail.jsp" data-lightgallery="group-item">
						                   <article class="post-blog th_a2_2_list" style="padding: 0px 0px 14px 0px; margin-bottom: 30px;background-color: white;">
						                   	   ...
						                   	   <div class="th_a2_2_imgTitle">
							                   	      <!-- 제목 --> 
							                   	     <a class="post-blog-image" href="/HappyRing_before_before/view/theory/theories/theoryBasic/theoryBasicDetail.jsp" > 
							                   	      <img alt="" src="/HappyRing_before_before/img/sample/baby.jpg" style="height:124px !important; width: auto !important; display: block; margin-left: auto; margin-right: auto;">
							                         </a> 
						                ...
						                <div class="col-xs-12 col-sm-4 col-md-4 isotope-item" data-filter="type 1">
						                 <a class="gallery-item" href="/HappyRing_before_before/view/theory/theories/theoryBasic/theoryBasicDetail.jsp" data-lightgallery="group-item">
						                   <article class="post-blog th_a2_2_list" style="padding: 0px 0px 14px 0px; margin-bottom: 30px;background-color: white;">
						                   	   ...
						                   	   <div class="th_a2_2_imgTitle">
							                   	      <!-- 제목 --> 
							                   	     <a class="post-blog-image" href="/HappyRing_before_before/view/theory/theories/theoryBasic/theoryBasicDetail.jsp"> 
							                   	      <img alt="" src="/HappyRing_before_before/img/sample/personality.png" style="height:124px !important; width: auto; display: block; margin-left: auto; margin-right: auto; ">
							                         </a> 
						                 ...
						                 <a class="gallery-item" href="/HappyRing_before_before/view/theory/theories/theoryBasic/theoryBasicDetail.jsp" data-lightgallery="group-item">
						                   <article class="post-blog th_a2_2_list" style="padding: 0px 0px 14px 0px; margin-bottom: 30px;background-color: white;">
						                   	   ...
						                   	   <div class="th_a2_2_imgTitle">
							                   	      <!-- 제목 --> 
							                   	     <a class="post-blog-image" href="/HappyRing_before_before/view/theory/theories/theoryBasic/theoryBasicDetail.jsp"> 
							                   	      <img alt="" src="/HappyRing_before/img/sample/psychology.jpg" style="height:124px !important; width: auto; display: block; margin-left: auto; margin-right: auto;">
							                         </a> 
						           ...
						           <% for(int i=0; i<6; i++ ) { %>
						               <div class="col-xs-12 col-sm-4 col-md-4 isotope-item" data-filter="type 1">
						                 <a class="gallery-item" href="/HappyRing_before/view/theory/theories/theoryBasic/theoryBasicDetail.jsp" data-lightgallery="group-item">
						                   <article class="post-blog th_a2_2_list" style="padding: 0px 0px 14px 0px; margin-bottom: 30px;background-color: white;">
						                   	   
						                   	   
						                   	   <div class="th_a2_2_imgTitle">
							                   	      <!-- 제목 --> 
							                   	     <a class="post-blog-image" href="/HappyRing_before/view/theory/theories/theoryBasic/theoryBasicDetail.jsp"> 
