						                   ...
						                   <article class="post-blog th_a2_2_list" style="padding: 0px 0px 14px 0px; margin-bottom: 30px;background-color: white;">
						                   	   ...
						                   	   <div class="th_a2_2_imgTitle">
							                   	     ...
							                   	     <a class="post-blog-image" href="/HappyRing_before/view/info/infoDetail.jsp" > 
							                   	      <img alt="" src="/HappyRing_before/img/sample/bright.png" style="height:124px !important; width: auto !important; display: block; margin-left: auto; margin-right: auto;">
							                         </a> 
						                 ...
						                 <a class="gallery-item" href="/HappyRing_before/view/info/infoDetail.jsp" data-lightgallery="group-item">
						                   <article class="post-blog th_a2_2_list" style="padding: 0px 0px 14px 0px; margin-bottom: 30px;background-color: white;">
						                   	   ...
						                   	   <div class="th_a2_2_imgTitle">
							                   	      <!-- 제목 --> 
							                   	     <a class="post-blog-image" href="/HappyRing_before/view/info/infoDetail.jsp"> 
							                   	      <img alt="" src="/HappyRing_before/img/sample/MyStory.png" style="height:124px !important; width: auto; display: block; margin-left: auto; margin-right: auto; ">
							                         </a> 
						                 ...
						                 <a class="gallery-item" href="/HappyRing_before/view/info/infoDetail.jsp" data-lightgallery="group-item">
						                   <article class="post-blog th_a2_2_list" style="padding: 0px 0px 14px 0px; margin-bottom: 30px;background-color: white;">
						                   	   ...
						                   	   <div class="th_a2_2_imgTitle">
							                   	      <!-- 제목 --> 
							                   	     <a class="post-blog-image" href="/HappyRing_before/view/info/infoDetail.jsp"> 
							                   	      <img alt="" src="/HappyRing_before/img/sample/sampleImg.png" style="height:124px !important; width: auto; display: block; margin-left: auto; margin-right: auto;">
							                         </a> 
