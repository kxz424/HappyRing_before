	    	  ...
	    	  <div class="a-2a">
					<div class="row">
	                  <div class="col-md-4" style="padding-left: 4%; margin-bottom: 2%;">
	                     <h3 class="hn">HappyRing_before column</h3>
	                  </div>
...
<!-- 			                        Isotope Filters -->
			                        ...
			                        <ul class="isotope-filters-list isotope-filters-list-buttons" id="isotope-filters-list-3">
			                          ...
			                          <li class="th_a2_2_li"><a class="th_a2_2_btn button-nina" data-isotope-filter="type 1" data-isotope-group="theory1" href="#">Dr.Happy</a></li>
			                          <li class="th_a2_2_li"><a class="th_a2_2_btn button-nina" data-isotope-filter="type 2" data-isotope-group="theory1" href="#">Dr.Dream</a></li>
			                        </ul>
			                      </li>
			                    </ul>
                   		    </div>
						                   ...
						                   <article class="post-blog th_a2_2_list" style="padding: 0px 0px 14px 0px; margin-bottom: 30px;background-color: white;">
						                   	   ...
						                   	   <div class="th_a2_2_imgTitle">
							                   	     ...
							                   	     <a class="post-blog-image" href="/HappyRing_before/view/info/infoDetail.jsp" > 
							                   	      <img alt="" src="/HappyRing_before/img/sample/baby.jpg" style="height:124px !important; width: auto !important; display: block; margin-left: auto; margin-right: auto;">
							                         </a> 
							                         
							                         <!-- 태그 -->
							                         <div class="company_title">
							                         	<a class="button-tags" href="single-post.html"><!-- 상담소 이름 -->Dr.Happy</a>
							                         </div>
							                          <!-- 내용 -->
						                 ...
						                 <a class="gallery-item" href="/HappyRing_before/view/info/infoDetail.jsp" data-lightgallery="group-item">
						                   <article class="post-blog th_a2_2_list" style="padding: 0px 0px 14px 0px; margin-bottom: 30px;background-color: white;">
						                   	   ...
						                   	   <div class="th_a2_2_imgTitle">
							                   	      <!-- 제목 --> 
							                   	     <a class="post-blog-image" href="/HappyRing_before/view/info/infoDetail.jsp"> 
							                   	      <img alt="" src="/HappyRing_before/img/sample/personality.png" style="height:124px !important; width: auto; display: block; margin-left: auto; margin-right: auto; ">
							                         </a> 
							                         
							                         <!-- 태그 -->
							                         <div class="company_title">
							                         	<a class="button-tags" href="single-post.html"><!-- 상담소 이름 -->Dr.Dream</a>
							                         </div>
							                          <!-- 내용 -->
								                      <div class="th_a2_2_text box-minimal-text" style="margin-top: 10px;">
